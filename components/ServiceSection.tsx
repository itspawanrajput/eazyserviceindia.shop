                  ...
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center gap-8 md:gap-12 pr-8 md:pr-12 shrink-0">
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <Editable id={`service-strip-1-${service.id}`} type="text">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <Editable id={`service-strip-2-${service.id}`} type="text">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <Editable id={`service-strip-3-${service.id}`} type="text">
          ...
          <div className="w-full md:w-1/2 flex flex-col py-2">
            ...
            >
              <div>
                ...
                <Editable id={`service-heading-${service.id}`} type="text">
                ...
                <div className="flex flex-wrap md:grid md:grid-cols-2 gap-x-6 gap-y-3 mb-6">
                  {service.content.map((item, idx) => (
                    <div key={idx} className="flex items-center group">
                      ...
                      <Editable id={`service-tag-${service.id}-${idx}`} type="text">
                ...
                {service.description && (
                  <Editable id={`service-desc-${service.id}`} type="text">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <Editable id={`service-btn-book-${service.id}`} type="button">
                  <motion.a 
                    href="#booking-form"
                ...
                <Editable id={`service-btn-call-${service.id}`} type="button">
                  <motion.a 
