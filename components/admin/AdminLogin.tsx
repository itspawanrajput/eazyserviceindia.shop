...
const AdminLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    setError('');
    sessionStorage.removeItem('admin_token'); // Clear any stale token
    try {
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-[32px] shadow-2xl p-8 md:p-10">
        <div className="text-center mb-10">
          ...
          <p className="text-[10px] text-slate-400 mt-2 italic">Default: admin / admin123</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full p-4 pl-12 pr-12 rounded-2xl bg-slate-50 border border-slate-100 focus:ring-2 focus:ring-blue-500 transition-all outline-none"
